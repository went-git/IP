...
func interact(player: CharacterBody2D) -> void:
	var messages = PackedStringArray([
		"Исаак!",
		"...",
		"тебя выселили ещё 2 дня назад",
		"Университет",
		"Закрыт",
		"Или бубонная чума не для церковных сайзеров, а?",
		"Будь так добр собери свои вещи",
		"(сайзер —— студент, прислуживающий священику",
		"ради избегая обычных рутинных обязанностей)"
	])
